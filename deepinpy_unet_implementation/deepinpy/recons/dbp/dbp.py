...
from deepinpy.models import ResNet5Block, ResNet, UNet
...
class DeepBasisPursuitRecon(Recon):
    ...
    def __init__(self, hparams):
        ...
        elif hparams.network == 'UNet':
            self.denoiser = UNet(batch_norm=hparams.batch_norm, l2lam=self.hparams.l2lam_init)
        self.debug_level = 0
